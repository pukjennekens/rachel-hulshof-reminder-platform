<form class="space-y-4" wire:submit.prevent="resetPassword">
    <x-input-group>
        ...
        <x-input-text type="password" name="password" placeholder="Vul je wachtwoord in" wire:model="password" />
        <x-input-errors name="password" />
    </x-input-group>

    <x-input-group>
        <x-input-label label="Bevestig wachtwoord" name="passwordConfirmation" />
        <x-input-text type="password" name="passwordConfirmation" placeholder="Bevestig je wachtwoord" wire:model="passwordConfirmation" />
